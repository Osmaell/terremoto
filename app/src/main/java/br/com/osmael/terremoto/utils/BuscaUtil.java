...
public class BuscaUtil {
    ...
    /** Simples resposta JSON para uma busca USGS */
     ...
     */
    public static List<Terremoto> obterTerremotos() {
        ...
        try {
            ...
            Log.e("BuscaUtil", "Problema ao fazer parsing para terremoto JSON resultado", e);
        }
